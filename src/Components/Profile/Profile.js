        ...
        <div className="profile__component">
            ...
            <div className="profile__rightSide">
                <div className="profile__titleEdit">
                    ...
                    <p className="profile__editBtn">Edit Profile</p>
                </div>
                <MyAds/>
            </div>
        </div>
